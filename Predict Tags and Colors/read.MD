I'll complete work to build a CV model using fastai using pytorch. After training a successful model, the model can predict the tags for any images with a certain high probability.
